  ...
  return (
    <>
      ...
      <div className="page-wrap" style={{paddingTop:28,paddingBottom:36}}>
        ...
        <h2 className="sec-title"><span className="accent">Tính toán dữ liệu</span><br />Dây quấn 3 pha 1 tốc độ 1 lớp</h2>
        <p className="sec-desc">Tính toán số liệu dây quấn stator động cơ điện 3 pha 1 tốc độ 1 lớp cảm ứng.</p>
          ...
          <div>
            <div className="card">
              <div className="card-header">
                ...
                <span className="tag blue" style={{marginLeft:'auto'}}>3 Pha 1 Lớp</span>
              </div>
          ...
          <div>
            <div className="card">
              <div className="card-header">
                ...
                <h4>Kết quả — Dây quấn 3 pha 1 lớp</h4>
