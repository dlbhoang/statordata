...
/* Khối nội dung KHÔNG thuộc Tab nào — tương ứng "PHẦN BÊN NGOÀI" trong tài liệu gốc. */
function ExternalBlock({ id, title, children }) {
      ...
      <div className={styles.externalBlock}>
        <div className={styles.tabSplit}>
          <div className={styles.tabSideList}>
            <button
              type="button"
              className={`${styles.tabSideBtn} ${isOpen ? styles.tabSideBtnActive : ''}`}
              onClick={() => setIsOpen(true)}
              aria-pressed={isOpen}
            >
              Nội dung phần bên ngoài
            </button>
          </div>
          <div className={styles.tabSideContent}>
            {isOpen ? (
              ...
              <div className={styles.emptyState}>Chọn mục bên trái để xem nội dung.</div>
            )}
          </div>
        </div>
      </div>
...
const NAV = [
  ...
  ['phan-ben-ngoai', 'Nội dung phần bên ngoài'],
];
  ...
  return (
    <>
      ...
      <div className="page-wrap" style={{ paddingTop: 28, paddingBottom: 48 }}>
        ...
        {/* ================= PHẦN BÊN NGOÀI (không thuộc Tab nào) ================= */}
        <ExternalBlock id="phan-ben-ngoai" title="Nội dung phần bên ngoài">
          <h4 className={styles.subTitle}>Sơ đồ hình tia sức điện động rãnh — sức điện động bối dây</h4>
          <h4 className={styles.subTitle} style={{ fontSize: 14 }}>1.1. Các khái niệm và định nghĩa</h4>
          ...
          <h4 className={styles.subTitle} style={{ fontSize: 14 }}>Xác định vùng cho dây quấn 2 lớp</h4>
          <Figure
          ...
          <h4 className={styles.subTitle} style={{ fontSize: 14 }}>Hệ số dây quấn 1 lớp</h4>
          ...
          <h4 className={styles.subTitle} style={{ fontSize: 14 }}>Hệ số dây quấn 2 lớp</h4>
