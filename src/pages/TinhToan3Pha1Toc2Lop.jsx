...
const INIT = { nu:1450, f:50, z:36, p:4, u:220, eta:0.75, cosphi:0.92, j:6, bdelta:0.8 };
  ...
  return (
    <>
      ...
      <div className="page-wrap" style={{paddingTop:28,paddingBottom:36}}>
        ...
        <h2 className="sec-title"><span className="accent">Tính toán dữ liệu</span><br />Dây quấn 3 pha 1 tốc độ 2 lớp</h2>
        <p className="sec-desc">Tính toán số liệu dây quấn stator động cơ điện 3 pha 1 tốc độ 2 lớp cảm ứng.</p>
          ...
          <div>
            <div className="card">
              <div className="card-header">
                ...
                <span className="tag blue" style={{marginLeft:'auto'}}>3 Pha 2 Lớp</span>
              </div>
          ...
          <div>
            <div className="card">
              <div className="card-header">
                ...
                <h4>Kết quả — Dây quấn 3 pha 2 lớp</h4>
              ...
              <div className="card-body">
                {!calc ? (
                  ...
                  <>
                    <div style={{marginBottom:14}}>
                      ...
                      <div className={styles.results}>
                        {[
                          ...
                          ['Phân loại',isInt ? 'Số nguyên' : 'Phân số','green']
                        ].map(([l,v,c])=>(
                    ...
                    <hr style={{border:'none',borderTop:'1px solid var(--border)',margin:'14px 0'}}/>
                    <div>
                      <div style={{fontSize:12,fontWeight:700,color:'var(--navy)',marginBottom:8,textTransform:'uppercase',letterSpacing:'.5px'}}>Thông số điện từ</div>
                      <div className={styles.results}>
                        {[
                          ['Số vòng dây N1',`${n1} vòng`,'cyan'],
                          ['Dòng điện I',`${I.toFixed(2)} A`,'cyan'],
                          ['Đường kính dây',`${dcu.toFixed(2)} mm`,'red']
                        ].map(([l,v,c])=>(
                          <div key={l} className={styles.resRow}><span className={styles.resLabel}>{l}</span><span className={`tag ${c}`}>{v}</span></div>
                        ))}
                      </div>
